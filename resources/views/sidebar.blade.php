...
<head>
    ...
    <title>SIC - Sistema de Información Corporativa</title>
</head>
...
<body>
    ...
    <div class="bg-[#2f4050] h-screen p-5 pt-8 relative ">
            ...
            <ul class="pt-20 space-y-9">
                <li
                    class="text-[#9CB1C2] text-sm flex items-center gap-x-4 cursor-pointer p-2 hover:text-white rounded-md font-medium">
